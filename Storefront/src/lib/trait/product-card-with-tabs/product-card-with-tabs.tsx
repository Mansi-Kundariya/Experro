...
const ExpProductCardWithTabs: React.FC = ({
  value,
  changeHandler,
}: {
  value: any;
  ...
  }, [traitData, tabsData, setTabsData, changeHandler, curruntActiveTab]);
        ...
        <div className="gjs-field">
          <div className="deviceImageTab">
            <div className="deviceImageTabButton">
              ...
              <button
                className={curruntActiveTab === 'tab6' ? 'active' : ''}
                onClick={() => {
                  saveTabsSettings('tab6');
                }}>
                Tab 6
              </button>
            </div>
...
const expProductCardWithTabsTrait: TraitInterface = {
  traitName: 'product-card-with-tabs',
