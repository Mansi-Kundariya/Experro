...
const ExpCustomImageselector: React.FC<any> = ({ traitData, setTraitData }) => {
  ...
  window.mediaManagerCallback = function (file: any, mediaUrl) {
  ...
  const saveImageSettings = () => {
    setTraitData({ ...traitData, ['imageData']: imageData });
  };
...
export default ExpCustomImageselector;
