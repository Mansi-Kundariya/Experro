...
import { ExpRecommendedForYou } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/recommended_for_you.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'recommended_for_you',
};
...
const ExpRecommendedForYouWidget = Widget.createWidget({
  component: ExpRecommendedForYou,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Recommended For You</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpRecommendedForYou/>',
  widgetName: 'ExpRecommendedForYou',
  widgetProperties: {
    defaults: {
...
export default ExpRecommendedForYouWidget;
