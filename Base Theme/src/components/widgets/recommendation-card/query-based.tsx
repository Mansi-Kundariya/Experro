...
import { ExpQueryBased } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/query_based.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'query_based',
};
...
const ExpQueryBasedWidget = Widget.createWidget({
  component: ExpQueryBased,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Query Based</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpQueryBased/>',
  widgetName: 'ExpQueryBased',
  widgetProperties: {
    defaults: {
      name: 'Query Based',
      attributes: {
...
export default ExpQueryBasedWidget;
