...
import { ExpRecentlyViewed } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/recently_viewed.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'recently_viewed',
};
...
const ExpRecentlyViewedWidget = Widget.createWidget({
  component: ExpRecentlyViewed,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Recently Viewed</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpRecentlyViewed/>',
  widgetName: 'ExpRecentlyViewed',
  widgetProperties: {
    defaults: {
...
export default ExpRecentlyViewedWidget;
