...
import { ExpBestSeller } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/best_seller.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'best_seller',
};
...
const ExpBestSellerWidget = Widget.createWidget({
  component: ExpBestSeller,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Best Seller</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpBestSeller/>',
  widgetName: 'ExpBestSeller',
  widgetProperties: {
    defaults: {
      name: 'Best Seller',
      attributes: {
...
export default ExpBestSellerWidget;
