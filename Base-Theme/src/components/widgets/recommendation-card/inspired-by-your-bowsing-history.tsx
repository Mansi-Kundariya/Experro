...
import { ExpInspiredByYourBrowsingHistory } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/inspired_by_your_browsing_history.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'inspired_by_your_browsing_history',
};
...
const ExpInspiredByYourBrowsingHistoryWidget = Widget.createWidget({
  component: ExpInspiredByYourBrowsingHistory,
  label:
  `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Inspired-By Your Browsing History</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpInspiredByYourBrowsingHistory/>',
  widgetName: 'ExpInspiredByYourBrowsingHistory',
  widgetProperties: {
    defaults: {
...
export default ExpInspiredByYourBrowsingHistoryWidget;
