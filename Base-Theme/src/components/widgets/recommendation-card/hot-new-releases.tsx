...
import { ExpHotNewReleases } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/hot_new_releases.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'hot_new_releases',
};
...
const ExpHotNewReleasesWidget = Widget.createWidget({
  component: ExpHotNewReleases,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Hot New Releases</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpHotNewReleases/>',
  widgetName: 'ExpHotNewReleases',
  widgetProperties: {
    defaults: {
...
export default ExpHotNewReleasesWidget;
