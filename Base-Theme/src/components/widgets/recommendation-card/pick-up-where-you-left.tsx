...
import { ExpPickUpWhereYouLeftOff } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/pick_up_where_you_left_off.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'pick_up_where_you_left_off',
};
...
const ExpPickUpWhereYouLeftOffWidget = Widget.createWidget({
  component: ExpPickUpWhereYouLeftOff,
  label: `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Pick-up Where You Left</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpPickUpWhereYouLeftOff/>',
  widgetName: 'ExpPickUpWhereYouLeftOff',
  widgetProperties: {
    defaults: {
...
export default ExpPickUpWhereYouLeftOffWidget;
