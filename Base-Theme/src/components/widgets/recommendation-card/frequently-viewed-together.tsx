...
import { ExpFrequentlyViewedTogether } from '../../e-commerce/recommendation-card';
...
import ExpWidgetImage from '../../../assets/images/recommendation-widget-images/frequently_viewed_together.png';

const initialValue: any = {
  tagLine: '',
  headingText: '',
  limit: '6',
  modalInternalName: 'frequently_viewed_together',
};
...
const ExpFrequentlyViewedTogetherWidget = Widget.createWidget({
  component: ExpFrequentlyViewedTogether,
  label:
  `<div  class='gjs-fonts gjs-f-b1 custom-widget custom-widget-bg-icon' style="background-image: url(${ExpWidgetImage});"></div><p>Frequently Viewed Together</p>`,
  category: 'Recommendations Widgets',
  content: '<ExpFrequentlyViewedTogether/>',
  widgetName: 'ExpFrequentlyViewedTogether',
  widgetProperties: {
    defaults: {
...
export default ExpFrequentlyViewedTogetherWidget;
