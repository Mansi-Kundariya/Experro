...
const ExpCTALayout2Widget = Widget.createWidget({
  component: ExpCTABanner2,
  label: `<div  class="gjs-fonts gjs-f-b1 custom-widget" style="background-image: url(${ExpWidgetImage});"></div><p>CTA Banner V2</p>`,
  category: 'CTA Banners',
  content: '<ExpCTABanner2/>',
  widgetName: 'ExpCTABanner2',
  widgetProperties: {
    defaults: {
      name: 'CTA Banner V2',
      attributes: {
...
export default ExpCTALayout2Widget;
