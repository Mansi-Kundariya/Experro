          ...
          {!!(
            ...
            <section
              ...
              <div className="cta-section-wrap relative basis-full shrink-0 overflow-hidden">
                <div className="min-h-[25rem] max-h-[25rem] lg:min-h-[37.5rem] lg:max-h-[37.5rem] [&>picture]:flex [&>picture]:h-full [&>picture]:min-h-[inherit] [&>picture]:max-h-[inherit] image-block">
                  <ExpImage
